...
INSERT INTO user_client_profile (id, account_id) VALUES ('client-profile-1', 'client-account-id-1');
INSERT INTO user_client_profile (id, account_id) VALUES ('manager-profile-1', 'manager-account-id-1');

INSERT INTO "order" (id, bill, created_on, payed_on, status, client_id)
VALUES ('order-id-1', 10000, '2023-11-17T00:00:00Z', null, 'UNPAID', 'client-profile-1');
